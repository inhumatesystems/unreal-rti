...
#ifndef GOOGLE_PROTOBUF_INCLUDED_InjectionOperation_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_InjectionOperation_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_InjectionOperation_2eproto INHUMATE_RTI_PROTOS_EXPORT
...
struct INHUMATE_RTI_PROTOS_EXPORT TableStruct_InjectionOperation_2eproto {
...
extern INHUMATE_RTI_PROTOS_EXPORT const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_InjectionOperation_2eproto;
namespace inhumate {
namespace rti {
namespace proto {
...
public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_InjectionOperation_2eproto);
    return ::descriptor_table_InjectionOperation_2eproto.file_level_metadata[0];
  }
...
class INHUMATE_RTI_PROTOS_EXPORT InjectionOperation_Inject :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_InjectionOperation_2eproto);
    return ::descriptor_table_InjectionOperation_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_InjectionOperation_2eproto;
};
// -------------------------------------------------------------------
...
// .google.protobuf.Empty request_update = 1;
inline bool InjectionOperation::_internal_has_request_update() const {
  return which_case() == kRequestUpdate;
}
inline bool InjectionOperation::has_request_update() const {
  return _internal_has_request_update();
}
inline void InjectionOperation::set_has_request_update() {
  _oneof_case_[0] = kRequestUpdate;
}
inline PROTOBUF_NAMESPACE_ID::Empty* InjectionOperation::release_request_update() {
  // @@protoc_insertion_point(field_release:inhumate.rti.proto.InjectionOperation.request_update)
...
inline const PROTOBUF_NAMESPACE_ID::Empty& InjectionOperation::_internal_request_update() const {
  return _internal_has_request_update()
      ? *which_.request_update_
      : *reinterpret_cast< PROTOBUF_NAMESPACE_ID::Empty*>(&PROTOBUF_NAMESPACE_ID::_Empty_default_instance_);
}
inline const PROTOBUF_NAMESPACE_ID::Empty& InjectionOperation::request_update() const {
  // @@protoc_insertion_point(field_get:inhumate.rti.proto.InjectionOperation.request_update)
  return _internal_request_update();
}
inline PROTOBUF_NAMESPACE_ID::Empty* InjectionOperation::_internal_mutable_request_update() {
  if (!_internal_has_request_update()) {
    clear_which();
...
inline PROTOBUF_NAMESPACE_ID::Empty* InjectionOperation::mutable_request_update() {
  // @@protoc_insertion_point(field_mutable:inhumate.rti.proto.InjectionOperation.request_update)
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_InjectionOperation_2eproto
