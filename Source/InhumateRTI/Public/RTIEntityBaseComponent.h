...
#include "RTIEntityBaseComponent.generated.h"
...
class INHUMATERTI_API URTIEntityBaseComponent : public URTIComponent
{
	GENERATED_BODY()

public:
    URTIEntityBaseComponent(const FObjectInitializer& init);
    URTIEntityBaseComponent(const FString& channelName, const bool stateless = false, const bool ephemeral = false);
...
private:
    ...
    static TMap< FString, TMap< FString, TArray<URTIEntityBaseComponent*> > > instances;
